...
:description: You can configure clusters to persist data structures and job snapshots on disk as well as fine-tune many other options such as enabling backups, encryption, and auto-recovery.
