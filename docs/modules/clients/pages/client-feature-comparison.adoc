...
[%collapsible]
====
Near Cache is highly recommended for data structures that are mostly read. xref:cluster-performance:best-practices.adoc[Learn more].
...
[%collapsible]
====
You can configure a Hazelcast cluster or client using either static or dynamic configuration. xref:data-structures:distributed-data-structures.adoc[Learn more].
