...
----
+
For further information on finding the discovery token in {hazelcast-cloud}, refer to the xref:cloud:ROOT:connect-to-cluster.adoc[Connecting to {hazelcast-cloud} Clusters, window=_blank] topic of the Hazelcast {hazelcast-cloud} documentation.
