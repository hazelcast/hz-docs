...
Flow:: Hazelcast Flow is a data gateway that automates the integration of microservices across an enterprise. 
...
[[streaming-data]]
Streaming data:: Also known as real-time data, event data, stream data processing, or data-in-motion, this refers to a continuous flow of information 
