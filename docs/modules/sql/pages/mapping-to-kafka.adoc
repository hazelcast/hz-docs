= Mapping to Kafka
:description: Before you can query streams in Kafka topics, you need to create a mapping with the Kafka connector so that the SQL service knows how to access messages in the most efficient way.
