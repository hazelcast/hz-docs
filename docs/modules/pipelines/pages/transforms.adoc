...
The non-keyed `mapStateful` operation attaches a stateful mapping stage to a pipeline that maintains a single shared state object per processor instance.
