...
To download and extract version 5.6.0 using the **curl** command:
```sh
curl -Lo hazelcast-cpp-client-5.6.0.tar.gz https://github.com/hazelcast/hazelcast-cpp-client/archive/v5.6.0.tar.gz
tar xzf hazelcast-cpp-client-5.6.0.tar.gz
```
