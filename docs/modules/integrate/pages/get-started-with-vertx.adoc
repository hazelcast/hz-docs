...
NOTE: You can get your trial key at https://hazelcast.com/get-started/?utm_source=docs-website or you can use `vertx-hazelcast` and a community edition of Hazelcast.
