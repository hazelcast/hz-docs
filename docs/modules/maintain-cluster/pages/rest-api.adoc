...
parameter value would be encoded as `name.with%20special%40chars`.

[NOTE]
====
For guidance on choosing names, see xref:data-structures:distributed-data-structures.adoc#naming-data-structures[Naming Data Structures].
====
