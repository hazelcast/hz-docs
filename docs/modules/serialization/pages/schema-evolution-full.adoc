...
4. Evolving nested records or collections
   ...
   - Because nested schemas have their own fingerprints, incompatibilities propagate transitively—if a nested type changes incompatibly, the parent becomes incompatible as well.
