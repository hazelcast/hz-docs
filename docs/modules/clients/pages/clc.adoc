...
The Hazelcast Command-Line Client (CLC) is a command-line tool to connect to and operate on Hazelcast Platform and xref:cloud:ROOT:preface.adoc[{hazelcast-cloud}]. You can use the CLC to execute commands through a terminal.
