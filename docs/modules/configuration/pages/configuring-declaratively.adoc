...
When a member is running, you can use dynamic configuration to add some supported configuration to a configuration file at runtime. See xref:dynamic-data-structure-configuration.adoc[].
