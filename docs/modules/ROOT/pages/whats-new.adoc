...
For detailed documentation, including differences between the clients and how to migrate from the embedded client to the standalone client, see xref:integrate:java#java-client-standalone-beta[].
