...
NOTE: If the Service is exposing multiple ports, it is recommended that you name the port that is exposing Hazelcast member as `hazelcast` in order for auto-discovery to function correctly.
