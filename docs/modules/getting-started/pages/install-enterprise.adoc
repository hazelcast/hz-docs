...
--
ifdef::snapshot[]
Download and extract the Hazelcast ZIP file from link:https://hazelcast.jfrog.io/ui/native/snapshot/com/hazelcast/hazelcast-enterprise-distribution/{ee-version}[the repository].
endif::[]
ifndef::snapshot[]
