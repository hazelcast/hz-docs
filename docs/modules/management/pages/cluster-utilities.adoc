= Cluster utilities
:description: Hazelcast Platform is provided with a range of programmatic utilities that you can use to manage your Hazelcast clusters, including command line interfaces and scripts. These utilities are included in the `bin` directory in your Hazelcast package.
