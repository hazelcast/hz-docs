...
The Jet API contains a range of link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/aggregate/AggregateOperations.html[predefined aggregate functions],
but it also exposes an abstraction, called
link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/aggregate/AggregateOperation.html[`AggregateOperation`],
...
offers in the
link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/accumulator/package-summary.html[`com.hazelcast.jet.accumulator`]
package several such classes, one of them being
link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/accumulator/LongLongAccumulator.html[`LongLongAccumulator`],
...
when done. You can use aggregate operations link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/aggregate/AggregateOperations.html[provided in the library]
(see the section on
