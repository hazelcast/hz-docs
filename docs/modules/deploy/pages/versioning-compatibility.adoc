...
For each Platform version, you can see which versions of Management Center (MC), Hazelcast Operator, CLC, and all official clients (Java, .NET, C++, Python, Node.js, Go) are recommended or supported. 
