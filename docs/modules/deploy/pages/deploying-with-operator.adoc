...
You can access the Management Center dashboard by using the external IP of the Load Balancer.

[source,shell]
----
kubectl get service managementcenter-sample -o jsonpath='{.status.loadBalancer.ingress[0].ip}'
----
