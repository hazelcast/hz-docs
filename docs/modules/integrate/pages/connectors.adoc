...
|hazelcast-jet-pulsar
|streaming (many consumer per topic to distribute reading)
|exactly-once

|xref:integrate:pulsar-connector.adoc[PulsarSources.pulsarReader]
|hazelcast-jet-pulsar
|streaming (single reader per topic)
|exactly-once
...
|xref:integrate:jcache-connector.adoc[Sources.cache], xref:integrate:jcache-connector.adoc[Sources.remoteCache]
|hazelcast
|batch
|N/A

|xref:integrate:jcache-connector.adoc[Sources.cacheJournal], xref:integrate:jcache-connector.adoc[Sources.remoteCacheJournal]
|hazelcast
|streaming
|exactly-once
...
|xref:integrate:list-connector.adoc[Sources.list], xref:integrate:list-connector.adoc[Sources.remoteList]
|hazelcast
|batch
|N/A

|xref:integrate:map-connector.adoc[Sources.map], xref:integrate:map-connector.adoc[Sources.remoteMap]
|hazelcast
|batch
|N/A

|xref:integrate:map-connector.adoc[Sources.mapJournal], xref:integrate:map-connector.adoc[Sources.remoteMapJournal]
|hazelcast
|streaming
|exactly-once
...
|xref:integrate:jcache-connector.adoc[Sinks.cache], xref:integrate:jcache-connector.adoc[Sinks.remoteCache]
|hazelcast
|streaming
|at-least-once
...
|xref:integrate:list-connector.adoc[Sinks.list], xref:integrate:list-connector.adoc[Sinks.remoteList]
|hazelcast
|batch
|N/A

|xref:integrate:map-connector.adoc[Sinks.map], xref:integrate:map-connector.adoc[Sinks.remoteMap]
|hazelcast
|streaming
|at-least-once
...
|xref:integrate:reliable-topic-connector.adoc[Sinks.reliableTopic], xref:integrate:reliable-topic-connector.adoc[Sinks.remoteReliableTopic]
|hazelcast
|streaming
|at-least-once
