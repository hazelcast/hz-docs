...
:page-api-reference: https://docs.hazelcast.org/hazelcast-java-client-docs/{page-latest-supported-java-client-new}/apidocs
:page-toclevels: 1
...
* https://docs.hazelcast.org/hazelcast-java-client-docs/{page-latest-supported-java-client-new}/apidocs[Hazelcast {java-client-new} API documentation]
...
* https://docs.hazelcast.org/hazelcast-java-client-docs/{page-latest-supported-java-client-new}/apidocs/com/hazelcast/client/config/ClientSecurityConfig.html[{java-client} ClientSecurityConfig API documentation]
