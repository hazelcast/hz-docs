...
== Step 2. Configure the File Connector

To allow Hazelcast to find and recognize the data in your CSV file, you need to configure the file connector.
...
== Step 6. Ingest Query Results into a Hazelcast Map
