...
[source,shell]
----
bin/hazelcast cancel hello-world
----
...
[source,shell]
----
bin/hazelcast suspend hello-world
----
...
[source,shell]
----
bin/hazelcast resume hello-world
----
...
[source,shell]
----
bin/hazelcast restart hello-world
----
