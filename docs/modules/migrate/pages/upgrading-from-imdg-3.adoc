...
3.12 to Platform 5.3. See xref:migrate:migration-tool-imdg.adoc[].
...
The only way to upgrade to Platform 5.3 is to completely shutdown the cluster.
...
| *_3.12.x (MapReduce)_* | *_5.3 (Jet Engine)_*
...
5.3, we have the following events instead:
...
See the following table showing the interface code before and 5.3.
