...
You can use the Hazelcast Java client to submit your isolated job as follows:
...
For further information on isolated jobs, see xref:pipelines:compute-isolation.adoc[].
