...
As it is a distributed key-value implementation, above operations involve remote calls, and their 
performance differs from non-distributed structures like ``HashMap``s.
