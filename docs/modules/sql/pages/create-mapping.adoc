...
DATA CONNECTION myJDBCconnection
OPTIONS (
    'keyFormat'='varchar',
    'valueFormat'='varchar');
...
|`resource_type`
|An optional name of the resource in the external system. For a JDBC connector, the resource may be the name of a table, view, or other data structure.
|
[source,sql]
----
CREATE MAPPING mytransactions (
