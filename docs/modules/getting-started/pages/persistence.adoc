...
----
<1> Replace the `<host_ip>` placeholder with the IP address of your member's Docker container.
...
Replace the `<host_ip>` placeholders with the IP address of your member's Docker container.
