...
IMPORTANT: There is a known issue with release 5.5.3 of Hazelcast Platform Enterprise Edition that affects some Jet and SQL configurations. Please DO NOT upgrade to this release. If you have already upgraded to 5.5.3 and you are using Jet or SQL, please contact Hazelcast Support. We are working on the issue and will provide further detail as soon as we can. In addition, we should have a 5.5.4 release out next week for any affected customers.
