...
:description: Not all features are available in every client. The following tables provides an at-a-glance overview of what each client offers, and a detailed list of specific features.

{description}

NOTE: Key to symbols: icon:check-circle[size=lg,role=success] -- supported; icon:circle-xmark[size=lg,role=error] -- not supported; icon:check-circle[size=lg,role=success] -- partially supported
