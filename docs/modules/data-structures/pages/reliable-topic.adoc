...
Reliable Topic offers the following metrics:

1. Publish operation count: the total number of messages published to the topic.
2. Receive operation count: the total number of messages received from the topic.
3. Creation time: when the topic was created on the member.

For more information about the metrics, see https://docs.hazelcast.com/hazelcast/latest/maintain-cluster/monitoring#topic-statistics[Topic Statistics].
