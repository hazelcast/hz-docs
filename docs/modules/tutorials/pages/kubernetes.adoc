...
There are different ways of deploying Hazelcast to Kubernetes. For production environments we recommend using Hazelcast Platform Operator or Helm because these methods provide the complete Hazelcast experience, including the following aspects:
