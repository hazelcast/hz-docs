...
:description: You can configure a map with the xref:working-with-external-data.adoc#options[generic MapStore] to use it as a cache with an external data store.
:page-beta: true
