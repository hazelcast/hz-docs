...
|requireSnapshotBeforeProcessing
|When enabled, the job performs an initial snapshot before processing any data and transitions to RUNNING only after the snapshot completes successfully.
|`boolean`
|false
