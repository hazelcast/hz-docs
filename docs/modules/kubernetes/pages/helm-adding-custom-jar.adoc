...
NOTE: We strongly recommend that you use Hazelcast Platform Operator's xref:operator:user-code-deployment.adoc[User Code Deployment] feature if you need to add a custom JAR to your Hazelcast members.
