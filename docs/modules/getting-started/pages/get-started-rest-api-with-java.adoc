= Getting Started with REST API Using Java
...
You need to set up a Java project that you can later execute to start a Hazelcast member with REST API. Add the following dependencies to your `pom.xml` file.
