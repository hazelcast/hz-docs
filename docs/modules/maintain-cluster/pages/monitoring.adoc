...
For more information on how to enable dynamic diagnostic logging, see the Operator or Management Center documentation (author's note - XREF Operator and Management Center documentation).
