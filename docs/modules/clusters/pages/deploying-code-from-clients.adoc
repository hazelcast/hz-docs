...
[source,java]
----
include6.0-snapshot@hazelcast::ROOT:example$/spring/spring-configuration/src/main/java/com/hazelcast/springconfiguration/HazelcastDataTypes.java[tag=iep]
----
