...
The Beta version of the {ucn} feature, which extends {ucd} to allow you to undeploy and redeploy your classes, is available for Enterprise users.

Users can continue to deploy their user code using {ucd}. 
