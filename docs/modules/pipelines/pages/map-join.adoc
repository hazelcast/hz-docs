...
```bash
gradle build
bin/hazelcast submit build/libs/map-join-tutorial-1.0-SNAPSHOT.jar
```
--
Maven:: 
+ 
...
```bash
mvn package
bin/hazelcast submit target/map-join-tutorial-1.0-SNAPSHOT.jar
```
--
====
...
+
```bash
bin/hazelcast cancel map-join-tutorial
```
