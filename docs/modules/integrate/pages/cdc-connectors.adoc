...
.3+|INT32
|-|int/Integer
|io.debezium.time.Date|java.time.LocalDate / java.util.Date / String
|io.debezium.time.Time|java.time.Duration / String

.5+|INT64
|-|long/Long
|io.debezium.time.Timestamp|java.time.Instant / String
|io.debezium.time.MicroTimestamp|java.time.Instant / String
|io.debezium.time.MicroTime|java.time.Duration / String
|io.debezium.time.NanoTimestamp|java.time.Instant / String
|io.debezium.time.NanoTime|java.time.Duration / String
