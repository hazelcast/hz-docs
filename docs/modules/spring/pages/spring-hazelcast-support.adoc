...
Spring Integration provides channel adapters and other utility components to interact with Hazelcast.
...
----
compile "org.springframework.integration:spring-integration-hazelcast:6.5.2"
----
======
...
The link:https://docs.spring.io/spring-integration/reference/channel/implementations.html#channel-implementations-queuechannel[`QueueChannel`] can be supplied by any `java.util.Queue`, including the mentioned Hazelcast distributed `IQueue`:
...
This works similar to link:https://docs.spring.io/spring-integration/reference/jms.html#jms-channel[`PollableJmsChannel`], link:https://docs.spring.io/spring-integration/reference/kafka.html#kafka-channels[`PollableKafkaChannel`] or link:https://docs.spring.io/spring-integration/reference/amqp/channels.html[`PollableAmqpChannel`].
...
In this case, the `QueueChannel` approach is wrong on the consumer side: an link:https://docs.spring.io/spring-integration/reference/channel-adapter.html#channel-adapter-namespace-inbound[Inbound Channel Adapter] solution must be used instead:
