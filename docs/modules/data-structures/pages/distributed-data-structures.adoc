...
|===
|AP Data structure|Description|Partitioned/Non-partitioned|xref:architecture:architecture.adoc#apcp[AP/CP]
...
[cols="20%a,40%a,20%a,20%a"]
|===
|CP Data structure|Description|Partitioned/Non-partitioned|xref:architecture:architecture.adoc#apcp[AP/CP]
...
[cols="20%a,40%a,20%a,20%a"]
|===
|Streaming Data structure|Description|Partitioned/Non-partitioned|xref:architecture:architecture.adoc#apcp[AP/CP]
...
[cols="20%a,40%a,20%a,20%a"]
|===
|AI/ML Data structure|Description|Partitioned/Non-partitioned|xref:architecture:architecture.adoc#apcp[AP/CP]
