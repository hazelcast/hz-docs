...
Your LTS release member can join clusters that include members from an earlier supported version. However, it cannot join clusters with more than two different minor versions in the same cluster.
