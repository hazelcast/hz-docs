...
See the https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/cluster/Cluster.html[Cluster interface Javadoc^] for information about these methods.
