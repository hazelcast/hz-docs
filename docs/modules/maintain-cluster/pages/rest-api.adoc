...
+
To trigger a partial-start when pPersistence is enabled, use the following command:
+
[source,shell]
----
...
+
To trigger a force-start when pPersistence is enabled, use the following command:
+
[source,shell]
----
