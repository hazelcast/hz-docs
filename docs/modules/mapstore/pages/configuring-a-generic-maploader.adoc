...
For a list of all supported external systems, including databases, see xref:external-data-stores:external-data-stores.adoc#connectors[pre-built data connectors].
...
You can use any database as the MapStore backend as long as you have it's Hazelcast SQL Connector on the classpath.
