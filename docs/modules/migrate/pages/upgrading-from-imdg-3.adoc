...
See xref:getting-started:wan-replication-tutorial.adoc[WAN Replication] for more information.
...
After introduction of the _CP Subsystem_ in Hazelcast IMDG 3.12,
...
After Hazelcast IMDG 3.12, the _CP Subsystem_ has received
