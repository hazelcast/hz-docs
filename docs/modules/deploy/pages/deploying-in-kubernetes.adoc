...
:description: Deploy Hazelcast clusters in Kubernetes-based environments.
...
* Hazelcast versions compatibility:
...
== Discovering Members in Kubernetes Automatically

To make it easier to set up clusters in Kubernetes, Hazelcast comes a plugin that allows members to discover each other automatically.
