...
To get started using the {java-client-new}, you need to iadd `hazelcast-java-client` artifact dependency in your pom.xml as shown below. You can then start using this client as if
you are using the Hazelcast API.
[source,xml,subs="attributes+"]
----
<dependency>
...
If you are using `hazelcast-enterprise-java-client`, you need to add `hazelcast-enterprise-java-client` artifact dependency at your pom.xml file together with the private hazelcast repository as shown below:
[source,xml,subs="attributes+"]
----
<dependency>
    <groupId>com.hazelcast</groupId>
