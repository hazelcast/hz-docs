...
Hazelcast provides powerful diagnostic logging capabilities that generate comprehensive insights for troubleshooting and monitoring.
...
For information on how to enable dynamic diagnostic logging and the auto turn-off feature, see the link:https://docs.hazelcast.com/operator/latest/[Platform Operator] or xref:{page-latest-supported-mc}@management-center:clusters:diagnostic-logging.adoc[Management Center] documentation.

// test this Operator link:

xref:latest-snapshot@operator:configure-diagnostic-logging.adoc[Platform Operator]
