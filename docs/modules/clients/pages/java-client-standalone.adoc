...
:page-api-reference: https://docs.hazelcast.org/docs/{page-latest-supported-java-client-new}/javadoc
:page-toclevels: 2 
[[java-client]]

// uncomment when available
// TIP: For the latest API documentation, see https://docs.hazelcast.org/docs/{page-latest-supported-java-client-new}/javadoc[Hazelcast {java-client-new} docs].

== Get started

To get started using the {java-client-new}, you need to include the `hazelcast.jar` dependency in your classpath. You can then start using this client as if
...
+ 
--
Add `hazelcast-enterprise` dependency to your `pom.xml`:
...
+ 
--
Add `hazelcast` dependency to your `pom.xml`:
