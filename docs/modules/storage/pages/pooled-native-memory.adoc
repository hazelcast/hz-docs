...
* **Total allocated external memory in all thread pools and global allocator**: Shows the total amount of externally allocated memory from malloc. External allocation happens when requested size is larger than the page size.
