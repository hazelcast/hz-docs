...
To load data from external systems in a map you will use the Java link:https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/map/MapLoader.html[`MapLoader`] interface. 

To save map entries to an external system, you will use the Java link:https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/map/MapStore.html[`MapStore`] interface.
...
NOTE: If you add indices to your map with the link:https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/config/IndexConfig.html[IndexConfig^]
