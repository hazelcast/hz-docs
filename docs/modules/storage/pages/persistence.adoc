...
NOTE: If persistence is enabled for a map or cache, its configuration is also persisted, including the persistence of the related namespace.
If Jet persistence is enabled, the job-related namespace configuration is also persisted.
