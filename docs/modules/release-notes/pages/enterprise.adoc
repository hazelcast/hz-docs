...
* **Hardened Compact Serialization against data exposure and instability**: Added protections that prevent internal Hazelcast classes from being unexpectedly serialized with zero-config Compact Serialization.
