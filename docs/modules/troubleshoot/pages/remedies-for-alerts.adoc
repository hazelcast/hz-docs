...
TIP: For more options for capturing a heap dump, including if you don't have access to a JDK, see this https://www.baeldung.com/java-heap-dump-capture[Baeldung tutorial].
