...
To encrypt persisted data, you must enable it and configure at least the following required options:

- xref:configuring-persistence.adoc#persistence.enryption-at-rest.algorithm[`algorithm`]
- <<configuring-a-secure-store, `secure-store`>>
