...
to decrease or more importantly not to loose majorities of CP groups. It is
...
+ 
--
See xref:{page-latest-supported-mc}@management-center:clusters:cp-subsystem.adoc[] in the Management Center documentation.
--
