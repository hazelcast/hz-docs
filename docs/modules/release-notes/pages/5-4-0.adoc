...
* [.enterprise]*Enterprise* **User Code Namespaces**: Enable deployment, undeployment and redeployment of your custom classes. See the xref:clusters:pages:user-code-namespaces.adoc[User Code Namespaces documentation].
