...
NOTE: The DMT migrates your data for maps and replicated maps only. IMap data is migrated including your metadata like hits, ttl etc. Replicated map metadata is supported but with a custom jar you need to use and restart your source cluster members with.
