...
to perform any in-place or rolling upgrade from a running IMDG 3.x cluster to Platform 5.0.
...
the Hazelcast property `hazelcast.jcache.provider.type`. See the <<configuring-jcache-provider,
...
See the xref:ROOT:release-notes.adoc[Release Notes] for
