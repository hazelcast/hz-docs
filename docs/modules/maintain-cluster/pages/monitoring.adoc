...
For information on how to enable dynamic diagnostic logging and the auto turn-off feature, see the link:https://docs.hazelcast.com/operator/latest/[Platform Operator] or link:https://docs.hazelcast.com/management-center/latest/[Management Center] documentation.
