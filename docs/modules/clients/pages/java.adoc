...
To get started using the {java-client-new}, you need to include the `hazelcast-java-client-{page-latest-supported-java-client-new}.jar` dependency in your classpath. You can then start using this client as if
you are using the Hazelcast API. 
...
=== Configuring CP direct-to-leader operation routing for clients
