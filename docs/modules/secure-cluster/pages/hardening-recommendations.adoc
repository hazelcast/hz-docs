...
see the xref:configuration:configuring-declaratively.adoc[Using Variables section] on how to do it.
...
** See the xref:configuration:configuring-declaratively.adoc[Variable Replacers section] for more information about their usages and examples.
