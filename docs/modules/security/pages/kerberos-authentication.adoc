...
implementations. It normally uses the https://docs.oracle.com/en/java/javase/{minimum-java-version}/docs/api/jdk.security.auth/com/sun/security/auth/module/Krb5LoginModule.html[`com.sun.security.auth.module.Krb5LoginModule`] class.
