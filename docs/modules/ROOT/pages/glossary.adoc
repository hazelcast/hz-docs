...
Health check:: A Hazelcast feature that analyzes cluster member configurations and metrics to detect issues, misconfigurations, or best practice recommendations. Results are categorized by status and can be filtered or downloaded for further analysis.
