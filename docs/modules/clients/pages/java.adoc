...
If you are using `hazelcast-enterprise-java-client`, you also need to add this your pom.xml file:
[source,xml,subs="attributes+"]
----
<repositories>
    <repository>
...
// would you also need to add hazelcast-enterprise-java-client if using Maven as below?:
