...
aware when you have been using IMDG 3.12.x and want to use Hazelcast 5.0.

NOTE: See also xref:migrate:upgrade.adoc[Upgrading from IMDG and Jet Version 4.x]
to learn about the changes that need to be considered while upgrading from IMDG 4.x to Hazelcast 5.0.
