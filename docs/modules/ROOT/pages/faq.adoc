...
- Persistence Feature: Hazelcast provides a Persistence feature that allows data to be persisted to disk. This feature can be enabled to save data for recovery after planned shutdowns or unplanned failures
