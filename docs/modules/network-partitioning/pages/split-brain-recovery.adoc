...
* The split-brain recovery process initiates when the master member of the smaller cluster detects that of the larger cluster.
However, if the master of the larger cluster communicates with that of the smaller cluster, and not the other way around, the recovery process cannot commence.
====
