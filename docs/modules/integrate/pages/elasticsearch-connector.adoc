...
CAUTION: Elastic discontinued support for Elasticsearch 7 in January 2026. This connector is deprecated and will be removed in a future version of Hazelcast.
