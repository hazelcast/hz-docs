...
<1> The xref:configuration-guide.adoc#class-name[class name] of the generic MapLoader that's built into Hazelcast. This implementation reads from the external data store configuration to create a <<mapping, SQL mapping>>.
