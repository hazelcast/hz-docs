...
* Garbage collection (GC) logs should be enabled; since Java is getting better and better at GC, use the latest LTS version. G1GC is the default recommended GC policy.
