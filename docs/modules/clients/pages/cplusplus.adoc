...
----
[requires]
hazelcast-cpp-client/{page-latest-supported-cplusplus-client}
...
To download and extract version {page-latest-supported-cplusplus-client} using the **curl** command:

[source,shell,subs="attributes+"]
----
curl -Lo hazelcast-cpp-client-{page-latest-supported-cplusplus-client}.tar.gz https://github.com/hazelcast/hazelcast-cpp-client/archive/v{page-latest-supported-cplusplus-client}.tar.gz
tar xzf hazelcast-cpp-client-{page-latest-supported-cplusplus-client}.tar.gz
----
...
git checkout v{page-latest-supported-cplusplus-client}
----
...
[source,shell,subs="attributes+"]
----
cd hazelcast-cpp-client-{page-latest-supported-cplusplus-client}
mkdir build
cd build
----
