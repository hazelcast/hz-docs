...
* {enterprise-product-name}: https://docs.hazelcast.org/hazelcast-ee-docs/{ee-version}/javadoc
* {open-source-product-name}: https://docs.hazelcast.org/docs/{os-version}/javadoc
...
See <<client-system-properties, Client system Properties>> for a description of the `hazelcast.client.invocation.timeout.seconds` property.
