...
* When migrating from an {open-source-product-name} cluster to an {enterprise-product-name} Edition cluster
* When migrating from an earlier version of {enterprise-product-name} Edition to a newer version. Such a migration can move directly between specified versions, even if several minor versions exist between them
* When migrating from an on-premise cluster to a self-managed {enterprise-product-name} Edition cluster in the cloud
...
* The target cluster must be on 5.3.x {enterprise-product-name} Edition or the latest {hazelcast-cloud} release
...
* {enterprise-product-name} Edition version 5.3.2 or later 
* {hazelcast-cloud}
