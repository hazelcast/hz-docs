...
To apply permissions to certain mappings, provide the mapping name in the `name` attribute. Or, you can apply permissions to all mappings, using the `*` wildcard.
