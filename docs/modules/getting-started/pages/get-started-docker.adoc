...
+
Replace the `<host_ip>` placeholder with the IP address of your member's Docker container.
+
...
+
- `HZ_NETWORK_PUBLICADDRESS`: The public IP address of your member's Docker container.
