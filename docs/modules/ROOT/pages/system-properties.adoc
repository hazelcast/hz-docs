...
| false
| bool
| Controls if the xref:configuration:configuring-declaratively.adoc#variables[Configuration Variables/Templating] is enabled when updating the configuration via xref:maintain-cluster:enterprise-rest-api.adoc[Enterprise REST API].
