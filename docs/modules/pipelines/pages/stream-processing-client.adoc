...
<5> Set the name of this processing stage. Naming a processing stage makes it easier to recognize in the xref:{page-latest-supported-mc}@management-center:monitor-streaming:jobs.adoc#job-details[DAG view] of Management Center.
