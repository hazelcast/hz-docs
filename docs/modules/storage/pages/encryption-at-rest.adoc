...
:description: Data on disk may contain sensitive information such as in the keys or values of maps. To protect your data, you can configure Persistence to use encryption at rest, which encrypts all files in your persistence store.
...
The following are the example configuration settings for encryption at rest.
