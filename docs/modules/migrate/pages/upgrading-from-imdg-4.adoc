...
If you are using IMDG Enterprise version 4.x, you can migrate your data to a Hazelcast {page-component-version} cluster. See xref:migration-tool-imdg.adoc[].
...
[cols="1a,1a"]
|===
| IMDG 4.x |  Hazelcast {page-component-version}
