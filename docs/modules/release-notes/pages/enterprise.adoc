...
:page-aliases: release-notes:5-6-1.adoc
...
* *Resolved https://github.com/advisories/GHSA-72hv-8253-57qq[GHSA-72hv-8253-57qq] in Jackson*: Fixed a vulnerability by upgrading the Jackson dependency.
