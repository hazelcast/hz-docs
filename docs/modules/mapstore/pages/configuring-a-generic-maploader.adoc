...
|External name of the data (e.g. table or collection) to read from. May be case sensitive, depending on database used.
...
|SQL connector to use for the mapping. Case sensitive.
...
|[[id-column]]`id-column`
|Name of the column that contains the primary key. May be case sensitive, depending on database used.
...
the table. Missing columns must have a default value defined. May be case sensitive, depending on database used.
...
--
====
|[[single-column-as-value]]`single-column-as-value`
|If set to `true` and the table has only one column (besides the identifier column), the value of this column will be used as the value in the IMap, instead of `GenericRecord` with only one field.
...
<hazelcast>
  <map name="myMapName">
    <map-store enabled="true">
      ...
      <properties>
          <property name="data-connection-ref">my-mysql-database</property>
          <property name="single-column-as-value">true</property>
      </properties>
    </map-store>
</hazelcast>
----
...
mapStoreConfig.setClassName("com.hazelcast.mapstore.GenericMapStore");
mapStoreConfig.setProperty("data-connection-ref", "my-mysql-database");
mapStoreConfig.setProperty("single-column-as-value", "true");
...
|If set to `true`, all keys will be read during `MapLoader` initialization.
...
<hazelcast>
  <map name="myMapName">
    <map-store enabled="true">
      ...
      <properties>
          <property name="data-connection-ref">my-mysql-database</property>
          <property name="load-all-keys">true</property>
      </properties>
    </map-store>
</hazelcast>
----
...
mapStoreConfig.setClassName("com.hazelcast.mapstore.GenericMapStore");
mapStoreConfig.setProperty("data-connection-ref", "my-mysql-database");
mapStoreConfig.setProperty("load-all-keys", "true");
