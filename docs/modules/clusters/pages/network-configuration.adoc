...
* work with JDK 11 or newer, and recent JDK 8 distributions based on OpenJDK
* generally supported by macOS and Linux systems (not Windows OS).
...
See xref:configuration:configuring-with-system-properties[Configuring with System Properties] to see the alternative options.
+
[source,xml]
----
<hazelcast>
