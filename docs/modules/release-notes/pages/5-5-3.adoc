...
IMPORTANT: There is a known issue with release 5.5.3 of Hazelcast Platform Enterprise Edition that affects some Jet and SQL configurations. Please DO NOT upgrade to this release. If you have already upgraded to 5.5.3 and you are using Jet or SQL, please contact Hazelcast Support. You should upgrade to xref:release-notes:5-5-4.adoc[version 5.5.4].
