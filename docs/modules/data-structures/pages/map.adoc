...
*** `USED_NATIVE_MEMORY_SIZE`: ([navy]*Hazelcast Pro and Enterprise*) Maximum used native memory
size in megabytes per map for each Hazelcast instance.
*** `USED_NATIVE_MEMORY_PERCENTAGE`: ([navy]*Hazelcast Pro and Enterprise*) Maximum used native
memory size percentage per map for each Hazelcast instance.
*** `FREE_NATIVE_MEMORY_SIZE`: ([navy]*Hazelcast Pro and Enterprise*) Minimum free native memory
size in megabytes for each Hazelcast instance.
*** `FREE_NATIVE_MEMORY_PERCENTAGE`: ([navy]*Hazelcast Pro and Enterprise*) Minimum free native
