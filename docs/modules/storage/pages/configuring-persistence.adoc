...
NOTE: If you are running Hazelcast on Kubernetes, see xref:kubernetes:kubernetes-persistence.adoc[] for platform-specific guidance on rebalance delay configuration.
