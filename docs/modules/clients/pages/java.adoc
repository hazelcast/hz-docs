...
Since each xref:architecture:data-partitioning.adoc[data partition] uses the well known and consistent hashing algorithm,
...
See xref:cloud:ROOT:overview.adoc[Hazelcast {hazelcast-cloud}]
