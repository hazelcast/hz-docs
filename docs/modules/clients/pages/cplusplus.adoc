...
#AUTHORS NOTE—rather than giving them a link to the home page of the Docs site, is there a specific topic that would be more useful, such as the https://docs.hazelcast.com/hazelcast/latest/configuration/understanding-configuration[Configuration topic]?# 
