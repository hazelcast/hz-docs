...
You can connect your Java client to a Hazelcast cluster which is hosted on link:{url-cloud-signup}[{hazelcast-cloud}].
For this, you simply enable {hazelcast-cloud} and specify the cluster's discovery token provided while creating the cluster; this allows the Hazelcast cluster to discover your clients.
...
See xref:cloud:ROOT:preface.adoc[]
for more information about {hazelcast-cloud}.
