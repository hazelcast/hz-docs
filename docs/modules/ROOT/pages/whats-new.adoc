...
With the {enterprise-product-name} Hazelcast Platform 5.5 you can now use Debezium 2.x source. This connector is now included in the full distribution of Hazelcast {enterprise-product-name} and replaces old Debezium 1.9 connector. For more information, see xref:integrate:cdc-connectors.adoc[].
