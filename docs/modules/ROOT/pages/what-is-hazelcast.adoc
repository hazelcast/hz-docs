...
EXTERNAL CODE SAMPLE:

----
include::{page-latest-supported-templates}@templates:ROOT:example$/spring/spring-configuration/src/main/java/com/hazelcast/springconfiguration/HazelcastDataTypes.java[]
----
