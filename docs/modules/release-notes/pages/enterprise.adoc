...
There is currently a known compatibility issue between Spring Boot 4 and Hazelcast 5.6.0. We recommend using Spring Boot 3 with Hazelcast 5.6.0, or using Hazelcast 5.5.z with Spring Boot 4, until this issue is resolved.
