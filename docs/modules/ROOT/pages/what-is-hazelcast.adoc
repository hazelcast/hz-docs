...
image:hazelcast-platform-diagram.png[Hazelcast Platform Overview]
...
by replicating their state over WAN environments. See the xref:wan:wan-replication-tutorial.adoc[Synchronizing Data Across a WAN section].
