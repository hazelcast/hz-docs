...
`hazelcast/hazelcast-enterprise` Helm Chart (see xref:kubernetes:deploying-in-kubernetes.adoc#helm-chart[Hazelcast Platform Operator,window=_blank]) 
within the limitations of what is described in this section. 
