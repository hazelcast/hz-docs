...
Hazelcast does not support JDK 8 or 11. If you are using either of these version, upgrade to version 17 or later.
The garbage collectors of JDK 17+ have been improved to achieve much higher throughputs. 
