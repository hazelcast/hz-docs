...
* **xref:integrate:mongodb-connector[Connector for MongoDB]**: Read and write from/to MongoDB via this connector and execute SQL queries on Mongo collections directly from Hazelcast.
