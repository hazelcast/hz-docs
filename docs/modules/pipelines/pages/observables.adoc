= Receiving Pipeline Results on the Client
...
link:https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/ringbuffer/Ringbuffer.html[Ringbuffers]
