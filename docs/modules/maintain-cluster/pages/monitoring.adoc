...
For information on how to enable dynamic diagnostic logging and the auto turn-off feature, see the Platform Operator or Management Center documentation.
