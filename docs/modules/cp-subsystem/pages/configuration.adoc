...
+ 
--
Use the link:https://docs.hazelcast.org/docs/{os-version}/javadoc/com/hazelcast/config/cp/CPSubsystemConfig.html[`CPSubsystemConfig`] object.
...
+ 
--
Add configuration options to the link:https://docs.hazelcast.org/docs/{os-version}/javadoc/com/hazelcast/config/cp/FencedLockConfig.html[`FencedLockConfig` object].
...
+ 
--
Add configuration options to the link:https://docs.hazelcast.org/docs/{os-version}/javadoc/com/hazelcast/config/cp/SemaphoreConfig.html[`SemaphoreConfig` object].
...
+ 
--
Add configuration options to the link:https://docs.hazelcast.org/docs/{os-version}/javadoc/com/hazelcast/config/cp/CPMapConfig.html[`CPMap` object].
...
+
--
Add configuration options to the link:https://docs.hazelcast.org/docs/{os-version}/javadoc/com/hazelcast/config/cp/RaftAlgorithmConfig.html[`RaftAlgorithmConfig` object].
