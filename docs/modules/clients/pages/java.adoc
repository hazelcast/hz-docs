...
=== Java Client Cluster Routing Modes
...
For further information on Java cluster routing modes, see <<java-client-cluster-routing-modes,Java Cluster Routing Modes>>.
...
<<java-client-cluster-routing-modes, `SINGLE_MEMBER` cluster routing mode>>, we recommend that you set explicit
...
You can configure the cluster routing mode to suit your requirements, as described in <<java-client-cluster-routing-modes,Java Cluster Routing Modes>>.
...
For <<java-client-cluster-routing-modes, Java cluster routing modes>>, the behaviour is as follows:
