...
:page-aliases: release-notes:5-5-9.adoc, release-notes:5-5-8.adoc, release-notes:5-5-7.adoc, release-notes:5-5-6.adoc, release-notes:5-5-5.adoc, release-notes:5-5-4.adoc, release-notes:5-5-3.adoc, release-notes:5-5-2.adoc, release-notes:5-5-1.adoc
...
* **Prevented arbitrary file read through Jet `FileSources`:** Hardened Jet `FileSources` usage in serializable contexts to prevent crafted operations from reading files from members, including configuration, secrets, or data stored on disk.
...
* **Resolved high-severity vulnerabilities in third-party dependencies:** Upgraded affected dependencies to address reported vulnerabilities, including Jackson Core async parser DoS https://github.com/advisories/GHSA-72hv-8253-57qq[GHSA-72hv-8253-57qq], LZ4-Java https://nvd.nist.gov/vuln/detail/CVE-2025-66566[CVE-2025-66566], Tomcat https://nvd.nist.gov/vuln/detail/CVE-2025-66614[CVE-2025-66614] and https://nvd.nist.gov/vuln/detail/CVE-2026-24734[CVE-2026-24734], and Spring Boot https://nvd.nist.gov/vuln/detail/CVE-2026-40973[CVE-2026-40973].

* **Resolved high and critical CVEs identified by security scans:** Updated affected components to resolve high and critical CVEs https://nvd.nist.gov/vuln/detail/CVE-2026-2332[CVE-2026-2332], https://nvd.nist.gov/vuln/detail/CVE-2026-41293[CVE-2026-41293], https://nvd.nist.gov/vuln/detail/CVE-2026-42579[CVE-2026-42579], https://nvd.nist.gov/vuln/detail/CVE-2026-42581[CVE-2026-42581], https://nvd.nist.gov/vuln/detail/CVE-2026-42584[CVE-2026-42584], https://nvd.nist.gov/vuln/detail/CVE-2026-43512[CVE-2026-43512], https://nvd.nist.gov/vuln/detail/CVE-2026-43515[CVE-2026-43515], https://nvd.nist.gov/vuln/detail/CVE-2025-37731[CVE-2025-37731], https://nvd.nist.gov/vuln/detail/CVE-2025-67030[CVE-2025-67030], https://nvd.nist.gov/vuln/detail/CVE-2025-67721[CVE-2025-67721], https://nvd.nist.gov/vuln/detail/CVE-2026-33870[CVE-2026-33870], https://nvd.nist.gov/vuln/detail/CVE-2026-33871[CVE-2026-33871], https://nvd.nist.gov/vuln/detail/CVE-2026-41284[CVE-2026-41284], https://nvd.nist.gov/vuln/detail/CVE-2026-41838[CVE-2026-41838], https://nvd.nist.gov/vuln/detail/CVE-2026-41842[CVE-2026-41842], https://nvd.nist.gov/vuln/detail/CVE-2026-41848[CVE-2026-41848], https://nvd.nist.gov/vuln/detail/CVE-2026-41850[CVE-2026-41850], https://nvd.nist.gov/vuln/detail/CVE-2026-41851[CVE-2026-41851], https://nvd.nist.gov/vuln/detail/CVE-2026-42498[CVE-2026-42498], https://nvd.nist.gov/vuln/detail/CVE-2026-42578[CVE-2026-42578], https://nvd.nist.gov/vuln/detail/CVE-2026-42582[CVE-2026-42582], https://nvd.nist.gov/vuln/detail/CVE-2026-42583[CVE-2026-42583], https://nvd.nist.gov/vuln/detail/CVE-2026-42585[CVE-2026-42585], https://nvd.nist.gov/vuln/detail/CVE-2026-42586[CVE-2026-42586], https://nvd.nist.gov/vuln/detail/CVE-2026-42587[CVE-2026-42587], https://nvd.nist.gov/vuln/detail/CVE-2026-43513[CVE-2026-43513], https://nvd.nist.gov/vuln/detail/CVE-2026-44248[CVE-2026-44248], and https://nvd.nist.gov/vuln/detail/CVE-2026-5795[CVE-2026-5795].
...
* **Resolved https://nvd.nist.gov/vuln/detail/CVE-2025-5115[CVE-2025-5115] in Eclipse Jetty:** Fixed a vulnerability by upgrading the Eclipse Jetty dependency.

* **Security Advisory regarding Elasticsearch 7:** https://nvd.nist.gov/vuln/detail/CVE-2025-37731[CVE-2025-37731] and https://nvd.nist.gov/vuln/detail/CVE-2025-66566[CVE-2025-66566] have been identified in Elasticsearch 7. As Elasticsearch 7 is currently End of Life (EOL), no upstream fix is available from the vendor. We strongly recommend that users evaluate the security risks associated with this CVE. Support for Elasticsearch 7 will be removed in a future version of Hazelcast.

=== Fixes

* **Fixed IMap mutations failing after graceful shutdown when persistence is enabled:** Resolved an issue where certain shutdown-and-migration scenarios could leave stale records in the persistence store, later crashing the GC thread and causing subsequent `IMap` updates to fail until the member is restarted. The fix ensures persisted state is cleaned up correctly during migration so `IMap` operations remain reliable.

* **Fixed potential data loss after split-brain merge when using MapStore write-behind:** Resolved an issue where, after a split-brain merge, an extra background store worker could start on the merging member, leading to duplicate or out-of-order write-behind processing. This could result in lost updates when using a non-coalescing write-behind queue. The fix ensures only the correct store worker remains active after merge so write-behind behavior is consistent and reliable.
...
* **Resolved https://github.com/advisories/GHSA-wr62-c79q-cv37[CVE-2025-52520] and https://github.com/advisories/GHSA-25xr-qj8w-c4vf[CVE-2025-53506] in Spring Boot**: Fixed vulnerabilities transitively by upgrading the Sprint Boot version.
...
* **Fixed afterPut value to match persisted state in MapInterceptor**: Resolved an issue where `MapInterceptor.afterPut` could receive a value inconsistent with what was persisted, especially when a preceding `MapInterceptor.put` modified the value. The fix ensures `afterPut` always receives the exact value saved to the store.
