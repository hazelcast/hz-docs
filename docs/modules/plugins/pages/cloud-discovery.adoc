...
* Amazon EC2 discovery with xref:deploy:deploying-on-aws.adoc[Hazelcast AWS Discovery plugin]
* Amazon ECS/EC2 discovery with xref:deploy:deploying-on-aws.adoc[Hazelcast AWS Discovery plugin]
* Amazon ECS/Fargate with xref:deploy:deploying-on-aws.adoc[Hazelcast AWS Discovery plugin]
...
See the
xref:deploy:deploying-on-aws.adoc[Hazelcast AWS Plugin documentation]
for more details.
