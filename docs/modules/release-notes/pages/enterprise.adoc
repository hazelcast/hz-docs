...
:page-aliases: release-notes:5-6-1.adoc, release-notes:5-6-2.adoc
...
* *Fixed networking CPU spikes*: Prevented NIO threads from spinning when a member connection remains established but is dead.

* *Clarified locking behavior*: Updated IMap and MultiMap class documentation.
...
* *Blocked reflective access to additional classes*: Blocked further classes in the Predicate API and SQL paths to prevent reflective access to Hazelcast instances and sensitive objects.

* *Hardened client deserialization*: Added default Java serialization protections and extended the zero-config Compact serialization blocklist.
...
* *Resolved high-severity CVEs in third-party dependencies*: Upgraded affected dependencies to address reported vulnerabilities, including Apache Log4j https://nvd.nist.gov/vuln/detail/CVE-2026-34478[CVE-2026-34478], https://nvd.nist.gov/vuln/detail/CVE-2026-34480[CVE-2026-34480] and https://nvd.nist.gov/vuln/detail/CVE-2026-34481[CVE-2026-34481]; PostgreSQL JDBC driver https://nvd.nist.gov/vuln/detail/CVE-2026-42198[CVE-2026-42198]; and Spring and its transitive Tomcat dependency https://nvd.nist.gov/vuln/detail/CVE-2026-40973[CVE-2026-40973] and https://nvd.nist.gov/vuln/detail/CVE-2025-66614[CVE-2025-66614].

* *Resolved vulnerabilities in Jackson*: Addressed reported vulnerabilities, including Jackson Core async parser DoS https://github.com/advisories/GHSA-72hv-8253-57qq[GHSA-72hv-8253-57qq] and https://nvd.nist.gov/vuln/detail/CVE-2026-54512[CVE-2026-54512] and https://nvd.nist.gov/vuln/detail/CVE-2026-54513[CVE-2026-54513].

* *Resolved high and critical CVEs identified by security scans*: Addressed critical and high-severity vulnerabilities: https://nvd.nist.gov/vuln/detail/CVE-2026-41293[CVE-2026-41293], https://nvd.nist.gov/vuln/detail/CVE-2026-43512[CVE-2026-43512], https://nvd.nist.gov/vuln/detail/CVE-2026-43515[CVE-2026-43515], https://nvd.nist.gov/vuln/detail/CVE-2023-45859[CVE-2023-45859], https://nvd.nist.gov/vuln/detail/CVE-2023-45860[CVE-2023-45860], https://nvd.nist.gov/vuln/detail/CVE-2025-59250[CVE-2025-59250], https://nvd.nist.gov/vuln/detail/CVE-2026-0603[CVE-2026-0603], https://nvd.nist.gov/vuln/detail/CVE-2026-24734[CVE-2026-24734], https://nvd.nist.gov/vuln/detail/CVE-2026-24880[CVE-2026-24880], https://nvd.nist.gov/vuln/detail/CVE-2026-34483[CVE-2026-34483], https://nvd.nist.gov/vuln/detail/CVE-2026-34487[CVE-2026-34487], https://nvd.nist.gov/vuln/detail/CVE-2026-41284[CVE-2026-41284], https://nvd.nist.gov/vuln/detail/CVE-2026-42498[CVE-2026-42498], https://nvd.nist.gov/vuln/detail/CVE-2026-43513[CVE-2026-43513], and https://nvd.nist.gov/vuln/detail/CVE-2026-54291[CVE-2026-54291].
...
* https://github.com/guss77[guss77]
...
* *Improved clarity of “Max native memory size per partition” warning in member logs*: Enhanced the warning message logged when the calculated native memory size per partition exceeds the recommended threshold. The updated message now makes the calculation basis explicit, clarifies the rationale behind the recommendation, and advises when the warning can be safely ignored.
...
* *Improved IMap destruction to reduce tail latency and prevent data leaks*: Resolved an issue where destroying large NATIVE memory IMaps could enqueue destroy operations for all partitions at once, causing partition threads to process long blocks of destroy tasks and delaying other partitioned operations. The fix introduces batched execution of partition destroy operations, allowing normal operations to run between batches and significantly reducing tail latency. Additionally, the change prevents a potential data leak scenario where partition migrations during destruction could leave map data undeleted.
...
* *Fixed potential CP Subsystem state inconsistency after snapshot restore*: Resolved an issue where restored CP Subsystem state could be unintentionally changed by ongoing operations, leading to inconsistent behavior after recovery. The fix ensures that recovered data is no longer unintentionally modified by ongoing cluster operations.
...
* https://github.com/brianjones[Brian Jones]
...
There is currently a https://github.com/hazelcast/hazelcast/issues/26546[known compatibility issue between Spring Boot 4 and Hazelcast 5.6.0]. We recommend using Spring Boot 3 with Hazelcast 5.6.0, or using Hazelcast 5.5.z with Spring Boot 4, until this issue is resolved.
