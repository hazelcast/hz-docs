...
|`user.code.namespace.updateTime`
|ms
|Update time of a namespace configuration

|`user.code.namespace.resourceCount`
|count
|Number of resources contained in a namespace

|`user.code.namespace.resource.resourceType`
|enum
|The Ordinal of the enum type of the resource contained in a namespace

|`user.code.namespace.resource.resourceSizeBytes`
|bytes
