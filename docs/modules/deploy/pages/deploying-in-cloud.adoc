...
Deploy a Hazelcast application in a https://kubernetes.io/[Kubernetes^] environments, including the following that we have tested: GKE, EKS, AKS, OpenShift, IBM Cloud, Minikube.
