...
Hazelcast Pro and Enterprise Edition is a commercial offering from
...
NOTE: Hazelcast Pro and Enterprise license keys are required only for members.
You do not need to set a license key for your Java clients for which you
want to use the Pro and Enterprise features.

To use Hazelcast Pro or Enterprise, you need to set the provided license
