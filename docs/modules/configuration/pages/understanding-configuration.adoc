...
=======
Static configuration cannot be changed at runtime. To update static configuration, you must xref:maintain-cluster:restart-cluster.adoc[restart the cluster]. However, you can add <<dynamic-configuration, dynamic configuration>> for some features.
