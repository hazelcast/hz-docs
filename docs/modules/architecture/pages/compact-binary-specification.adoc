...
:description: This document describes the binary specification of Compact serialization. This document will describe what serialized data look like in binary.
