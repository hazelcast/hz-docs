...
- You cannot xref:storage:persistence.adoc[persist] SQL metadata on disk. This means that when a cluster restarts, it does not retain any SQL mappings, data connections, or views that you have created.
