...
|link:http://trialrequest.hazelcast.com/?utm_source=docs-website[Hazelcast website]
...
[NOTE]
====
If you previously used the `hazelcast` repository in GitHub, update Helm to access the latest charts in the new repository:
