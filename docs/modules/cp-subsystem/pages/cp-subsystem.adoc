...
Deployment of CP within Kubernetes is supported from Hazelcast 5.5 and covers the following scenarios
when using platform opertor our Helm Hazelcast Enterprise chart:
...
NOTE: CP is only supported on Kubernetes with CP persistence enabled. 
