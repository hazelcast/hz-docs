...
the security is xref:security:enabling-jaas.adoc[enabled] in Hazelcast, i.e., if you have Hazelcast {enterprise-product-name} Edition.
...
Note that you should enable security in the configuration, i.e., you should have the Hazelcast {enterprise-product-name} edition.
