...
<6> The first port number should match the port assigned in <1>. For subsequent members (e.g. second, third) you should increment the first port number but keep the second port number i.e. 5702:5701, 5703:5701.
