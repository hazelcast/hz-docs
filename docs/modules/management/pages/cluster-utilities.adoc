...
using the REST API. See the xref:5.0-snapshot@management-center:monitor-imdg:cluster-administration.adoc#hot-restart[Hot Restart (renamed to Persistence)]
...
Besides the Management Center's xref:5.0-snapshot@management-center:monitor-imdg:cluster-administration.adoc#hot-restart[Hot Restart (renamed to Persistence) tab] and
...
See the xref:5.0-snapshot@management-center:monitor-imdg:cluster-administration.adoc#hot-restart[Hot Restart (renamed to Persistence)]
