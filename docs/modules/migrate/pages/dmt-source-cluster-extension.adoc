...
WARNING: If your source cluster is newer than 5.3.7, you must not use the extension JAR since the APIs in the extension JAR already exists. If you use the extension JAR with a version of Hazelcast that includes the API that replaces the extension JAR, a class mismatches and migration failure can occur.
