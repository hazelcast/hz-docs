...
- link:https://jet-start.sh/javadoc/4.5/com/hazelcast/nio/serialization/Portable.html[com.hazelcast.nio.serialization.Portable]
- link:https://jet-start.sh/javadoc/4.5/com/hazelcast/nio/serialization/StreamSerializer.html[com.hazelcast.nio.serialization.StreamSerializer]
...
the Hazelcast
link:https://jet-start.sh/javadoc/4.5/com/hazelcast/nio/serialization/StreamSerializer.html[StreamSerializer]
