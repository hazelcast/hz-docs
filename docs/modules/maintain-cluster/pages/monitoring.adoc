...
any change in the client application logic or in the implementation of these must also be applied on
...
The `Job` class has a
https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/jet/Job.html#getMetrics--[`getMetrics()`]
method which returns a
https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/jet/core/metrics/JobMetrics.html[JobMetrics]
...
https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/jet/core/metrics/JobMetrics.html[JobMetrics API docs].
...
see the xref:management:cluster-utilities.adoc#cluster-member-states[Member States section]
...
see the xref:management:cluster-utilities.adoc#cluster-states[Cluster States section]
...
see the xref:management:cluster-utilities.adoc#safety-checking-cluster-members[Safety Checking section]
...
NOTE: See the xref:list-of-metrics.adoc[List of Hazelcast Metrics appendix] for the full list
