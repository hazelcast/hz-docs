...
The JVM options configuration file (`jvm.options`) is located under the `config/` folder
...
See the https://docs.oracle.com/javase/8/docs/technotes/guides/vm/gctuning/toc.html[GC Tuning guide] by Oracle for more information on the garbage collection in JVMs.
