...
include::pulsar-dc-configuration.adoc[]
...
TIP: You can use the xref:configuration:configuring-declaratively.adoc#encryptionreplacer[EncryptionReplacer class] to hide sensitive data in configuration files.
