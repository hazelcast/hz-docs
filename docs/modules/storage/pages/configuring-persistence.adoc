...
NOTE: For information on configuring persistence in Kubernetes environments, see xref:kubernetes:kubernetes-persistence.adoc[Running Hazelcast Enterprise with Persistence under Kubernetes].
