...
You can generate a PDF of this documentation by executing the `create-pdfs.sh` script.

To execute this script, you'll need the following prerequisites:
...
The result of this script is a `build` directory, in which the artifacts for the PDF files are assembled and the PDF files are generated.
