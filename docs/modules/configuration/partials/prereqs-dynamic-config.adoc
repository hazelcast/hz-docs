You can add new configuration only for some features. See xref:dynamic-config-overview.adoc#supported-dynamic-configuration-changes[Supported Dynamic Configuration Changes].
