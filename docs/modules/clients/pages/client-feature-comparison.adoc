...
NOTE: Key to symbols: icon:check-circle[size=lg,role=success] -- supported; icon:circle-xmark[size=lg,role=error] -- not supported; icon:circle-half-stroke[size=lg,role=warning] -- partially supported
