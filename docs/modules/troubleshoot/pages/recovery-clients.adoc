...
none of the members may be available. In this case, you can configure the client to act in several ways:

* Client can give up, throwing an exception and eventually shutting down.
