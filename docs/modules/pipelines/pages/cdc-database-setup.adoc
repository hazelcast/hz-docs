...
When using xref:sources-sinks.adoc#change-data-capture-cdc[CDC data
sources], you
...
possible in Hazelcast by using the link:https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/jet/cdc/DebeziumCdcSources.html[generic Debezium source].
...
For details see the
link:https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/jet/cdc/mysql/MySqlCdcSources.html[javadoc].
...
boolean flag specifying if state should be reset on reconnects or not.
For details see the
link:https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/jet/cdc/postgres/PostgresCdcSources.html[javadoc].
