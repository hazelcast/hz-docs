...
TIP: If you don't want to deploy your own self-managed cluster, try link:{url-cloud-signup}[{hazelcast-cloud}].
...
In client/server mode, the Hazelcast cluster is independant of your application, which means that they can be independently scaled.
