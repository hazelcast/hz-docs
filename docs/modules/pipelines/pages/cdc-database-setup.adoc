...
possible in Hazelcast by using the link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/cdc/DebeziumCdcSources.html[generic Debezium source].
...
For details see the
link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/cdc/mysql/MySqlCdcSources.html[javadoc].
...
boolean flag specifying if state should be reset on reconnects or not.
For details see the
link:https://jet-start.sh/javadoc/4.5/com/hazelcast/jet/cdc/postgres/PostgresCdcSources.html[javadoc].
