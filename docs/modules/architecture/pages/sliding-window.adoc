...
runs on every event and has state  the _accumulate_ function
 and a function that transforms the accumulated state after
seeing all the events  the _finish_ function:
