...
[NOTE]
====
When adding names to the `principal` attribute, do not include spaces before or after the name.

Hazelcast cannot currently map names that start or end with a space, or that include commas.
====
