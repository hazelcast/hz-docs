...
NOTE: For information on configuring persistence in Kubernetes environments, see xref:deploy:kubernetes-persistence[Running Hazelcast Enterprise with Persistence under Kubernetes].
