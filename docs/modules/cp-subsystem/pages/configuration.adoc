...
WARNING: The leadership rebalancing task works only with members within the CP group. For example, if you start a cluster that has three CP members with priority 0 (with group size also set to three), and you promote a new CP member with priority 100, the new CP member will not participate in the leadership rebalancing until it will not become a member of a CP group.
