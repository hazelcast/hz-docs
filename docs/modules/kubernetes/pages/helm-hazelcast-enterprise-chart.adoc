...
For users who already added `hazelcast` repo to their local helm client before with our previous GitHub repo; you need to run `helm repo add` command again to use latest charts at the new chart repo.
