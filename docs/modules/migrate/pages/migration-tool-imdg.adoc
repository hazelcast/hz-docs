...
The Hazelcast team will send you the migration tool as a special
distribution library called `{page-component-version}-migration.jar`.
...
You can start a migration member, from the the `{page-component-version}-migration.jar` as you would a plain Hazelcast
