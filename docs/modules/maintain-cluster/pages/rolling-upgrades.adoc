...
NOTE: If you are moving members from a {open-source-product-name} cluster to an {enterprise-product-name} cluster, use an in-place rolling restart instead of a rolling upgrade. See xref:migrate:rolling-restart.adoc[].
