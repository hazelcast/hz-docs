...
The following exceptions may occur during Hazelcast operations when an issue occurs:
...
* `CallerNotMemberException`: Thrown when an operation was sent by a machine which is not a member of
