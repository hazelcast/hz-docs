...
none of the requests are executed. If you want to use an atomic behavior, see the xref:xref:transactions:providing-xa-transactions.adoc[Transactions chapter].
