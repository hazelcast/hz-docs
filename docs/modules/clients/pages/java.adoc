...
to your `pom.xml`, which you may already have done to start using Hazelcast:
...
To use Maven for a client accessing an Enterprise cluster, include the private Hazelcast repository:
[source,xml,subs="attributes+"]
----
 <repositories>
        <repository>
