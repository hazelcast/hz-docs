...
.3+|INT32
|-|int/Integer
|io.debezium.time.Date|java.time.LocalDate / java.util.Date
|io.debezium.time.Time|java.time.Duration

.5+|INT64
|-|long/Long
|io.debezium.time.Timestamp|java.time.Instant
|io.debezium.time.MicroTimestamp|java.time.Instant
|io.debezium.time.MicroTime|java.time.Duration
|io.debezium.time.NanoTimestamp|java.time.Instant
|io.debezium.time.NanoTime|java.time.Duration
