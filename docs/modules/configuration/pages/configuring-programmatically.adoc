...
|link:https://docs.hazelcast.org/docs/5.0.2/javadoc/com/hazelcast/config/Config.html#loadFromStream-java.io.InputStream-java.util.Properties-[`Config.loadFromStream()`]
...
Use one of the following classes to build a config object from a configuration:
...
- link:https://docs.hazelcast.org/docs/5.0.2/javadoc/com/hazelcast/config/UrlYamlConfig.html[`UrlYamlConfig`]
...
working directory. You can control the name of the files that Hazelcast search for, using the
